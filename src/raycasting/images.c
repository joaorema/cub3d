...
{
    game->wall_img.img = mlx_xpm_file_to_image(game->mlx, "images/wall3.xpm",
    ...
    printf("Image loaded: %dx%d, bpp: %d, line_len: %d, endian: %d\n",
           game->wall_img.width,
           game->wall_img.height,
           game->wall_img.bits_per_pixel,
           game->wall_img.line_len,
